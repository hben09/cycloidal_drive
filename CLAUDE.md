...
| Ring pin length | 35mm | 4mm motor plate engagement + 27mm bore zone (open) + 4mm bearing-zone wall engagement. Motor plate has 10mm through-holes; pin sits at the inner end with 6mm of empty hole at the outer face. |
...
**Total assembly depth including NEMA 17:** ~65mm housing + 48mm motor body = **~113mm** (motor pilot recesses 2mm into the motor plate's outer face — already inside the 65mm housing depth, so it doesn't add or subtract from the total).
...
2. **Ring gear body** — Main cylinder with 21 ring-pin blind holes (4.20mm ⌀, 31mm deep, chamfered entry), output bearing seat bore, 8× M4 clearance through-holes. Lateral pin retention is provided by the motor plate (10mm through-holes) plus 4mm engagement at the bearing-zone end. No shoulder ring — 6814 bearings retained by press-fit + output cap.
